...
const PrivacyPolicyPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-white text-gray-900 black-scrollbar">
      <ScrollProgress />
      {/* Header */}
      ...
      <main className="max-w-4xl mx-auto px-6 lg:px-8 py-16">
        ...
        >
          <h1 className="text-5xl font-light tracking-tight mb-4 text-gray-900">Privacy Policy</h1>
          <p className="text-gray-600 text-lg mb-12">Last updated: {new Date().toLocaleDateString('en-US', { year: 'numeric', month: 'long', day: 'numeric' })}</p>

          <div className="prose max-w-none space-y-8 text-gray-700 leading-relaxed">
            <section>
              <h2 className="text-3xl font-light tracking-tight mb-4 text-gray-900">1. Introduction</h2>
              <p className="mb-4">
            ...
            <section>
              <h2 className="text-3xl font-light tracking-tight mb-4 text-gray-900">2. Information We Collect</h2>
              
              <h3 className="text-2xl font-light tracking-tight mb-3 text-gray-900 mt-6">2.1 Information You Provide</h3>
              ...
              <h3 className="text-2xl font-light tracking-tight mb-3 text-gray-900 mt-6">2.2 Automatically Collected Information</h3>
              ...
              <h3 className="text-2xl font-light tracking-tight mb-3 text-gray-900 mt-6">2.3 Third-Party Integrations</h3>
              <p className="mb-4">
            ...
            <section>
              <h2 className="text-3xl font-light tracking-tight mb-4 text-gray-900">3. How We Use Your Information</h2>
            ...
            <section>
              <h2 className="text-3xl font-light tracking-tight mb-4 text-gray-900">4. How We Share Your Information</h2>
              <p className="mb-4">We may share your information in the following circumstances:</p>
              
              <h3 className="text-2xl font-light tracking-tight mb-3 text-gray-900 mt-6">4.1 Service Providers</h3>
              <p className="mb-4">
              ...
              <h3 className="text-2xl font-light tracking-tight mb-3 text-gray-900 mt-6">4.2 Business Transfers</h3>
              <p className="mb-4">
                If we are involved in a merger, acquisition, or sale of assets, your information may be transferred as part of that transaction.
              </p>

              <h3 className="text-2xl font-light tracking-tight mb-3 text-gray-900 mt-6">4.3 Legal Requirements</h3>
              <p className="mb-4">
                We may disclose your information if required to do so by law or in response to valid requests by public authorities.
              </p>

              <h3 className="text-2xl font-light tracking-tight mb-3 text-gray-900 mt-6">4.4 With Your Consent</h3>
              <p className="mb-4">
                We may share your information with your consent or at your direction.
              </p>

              <h3 className="text-2xl font-light tracking-tight mb-3 text-gray-900 mt-6">4.5 Aggregated Data</h3>
              <p className="mb-4">
            ...
            <section>
              <h2 className="text-3xl font-light tracking-tight mb-4 text-gray-900">5. Data Security</h2>
              <p className="mb-4">
            ...
            <section>
              <h2 className="text-3xl font-light tracking-tight mb-4 text-gray-900">6. Data Retention</h2>
              <p className="mb-4">
            ...
            <section>
              <h2 className="text-3xl font-light tracking-tight mb-4 text-gray-900">7. Your Rights and Choices</h2>
            ...
            <section>
              <h2 className="text-3xl font-light tracking-tight mb-4 text-gray-900">8. Cookies and Tracking Technologies</h2>
              <p className="mb-4">
            ...
            <section>
              <h2 className="text-3xl font-light tracking-tight mb-4 text-gray-900">9. Children's Privacy</h2>
              <p className="mb-4">
            ...
            <section>
              <h2 className="text-3xl font-light tracking-tight mb-4 text-gray-900">10. International Data Transfers</h2>
              <p className="mb-4">
            ...
            <section>
              <h2 className="text-3xl font-light tracking-tight mb-4 text-gray-900">11. California Privacy Rights</h2>
              <p className="mb-4">
            ...
            <section>
              <h2 className="text-3xl font-light tracking-tight mb-4 text-gray-900">12. European Privacy Rights</h2>
              <p className="mb-4">
            ...
            <section>
              <h2 className="text-3xl font-light tracking-tight mb-4 text-gray-900">13. Changes to This Privacy Policy</h2>
              <p className="mb-4">
            ...
            <section>
              <h2 className="text-3xl font-light tracking-tight mb-4 text-gray-900">14. Contact Us</h2>
              <p className="mb-4">
