  ...
  return (
    <div className="min-h-screen bg-white text-gray-900 black-scrollbar">
      ...
      <main className="max-w-4xl mx-auto px-6 lg:px-8 py-16">
        ...
        >
          <h1 className="text-5xl font-light tracking-tight mb-4 text-gray-900">Terms of Service</h1>
          ...
          <div className="prose max-w-none space-y-8 text-gray-700 leading-relaxed">
            <section>
              <h2 className="text-3xl font-light tracking-tight mb-4 text-gray-900">1. Acceptance of Terms</h2>
              <p className="mb-4">
            ...
            <section>
              <h2 className="text-3xl font-light tracking-tight mb-4 text-gray-900">2. Description of Service</h2>
              <p className="mb-4">
            ...
            <section>
              <h2 className="text-3xl font-light tracking-tight mb-4 text-gray-900">3. User Accounts</h2>
              <p className="mb-4">
            ...
            <section>
              <h2 className="text-3xl font-light tracking-tight mb-4 text-gray-900">4. Acceptable Use</h2>
            ...
            <section>
              <h2 className="text-3xl font-light tracking-tight mb-4 text-gray-900">5. Intellectual Property</h2>
              <p className="mb-4">
            ...
            <section>
              <h2 className="text-3xl font-light tracking-tight mb-4 text-gray-900">6. Subscription and Payment</h2>
              <p className="mb-4">
            ...
            <section>
              <h2 className="text-3xl font-light tracking-tight mb-4 text-gray-900">7. Data and Privacy</h2>
              <p className="mb-4">
            ...
            <section>
              <h2 className="text-3xl font-light tracking-tight mb-4 text-gray-900">8. Service Availability</h2>
              <p className="mb-4">
            ...
            <section>
              <h2 className="text-3xl font-light tracking-tight mb-4 text-gray-900">9. Limitation of Liability</h2>
              <p className="mb-4">
            ...
            <section>
              <h2 className="text-3xl font-light tracking-tight mb-4 text-gray-900">10. Indemnification</h2>
              <p className="mb-4">
            ...
            <section>
              <h2 className="text-3xl font-light tracking-tight mb-4 text-gray-900">11. Termination</h2>
              <p className="mb-4">
            ...
            <section>
              <h2 className="text-3xl font-light tracking-tight mb-4 text-gray-900">12. Changes to Terms</h2>
              <p className="mb-4">
            ...
            <section>
              <h2 className="text-3xl font-light tracking-tight mb-4 text-gray-900">13. Governing Law</h2>
              <p className="mb-4">
            ...
            <section>
              <h2 className="text-3xl font-light tracking-tight mb-4 text-gray-900">14. Contact Information</h2>
              <p className="mb-4">
            ...
            <section>
              <h2 className="text-3xl font-light tracking-tight mb-4 text-gray-900">15. Severability</h2>
              <p className="mb-4">
